...
import com.uiresource.cookit.adapter.AdapterFriend;
...
public class Home  extends AppCompatActivity{
    ...
    ArrayList<Friend> ArrList;
    ListView ListViewF;
    ImageButton btnNofication;



    private void initView() {
        ArrList = new ArrayList<>();
        btnNofication =(ImageButton) findViewById(R.id.btnnewfeed);
        ListViewF = (ListView) findViewById(R.id.LvFriend);
        adapter = new AdapterFriend(
                getApplicationContext(),
                R.layout.itemfriend,ArrList
        );
        ...
        ListViewF.setOnItemClickListener(new AdapterView.OnItemClickListener(){
            ...
            public void onItemClick(AdapterView<?> adapterView, View view, int i, long l) {
                ...
                guidulieu.putExtra("friend",ArrList.get(i).getUsername());
        ...
        btnNofication.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                Intent guidulieu = new Intent(Home.this,Main.class);
                startActivity(guidulieu);
            }
        });
    }
